            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-8">
                        ...
                        <form action="{{ route('blogAdd') }}" method="post" class="form-add-many" enctype = "multipart/form-data">
                            @csrf
                            <p>Заголовок: <p>
                            ...
                            <div class="control-buttons">
                                <button type="submit" class="btn btn-success" href="{{ route('blogAdd') }}">Добавить</button>
                            </div>
                        </form>
                    </div>
                </div>
